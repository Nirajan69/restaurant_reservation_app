...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset ('') }}coreui/https://cdn.jsdelivr.net/npm/prismjs@1.23.0/themes/prism.css">
  ...
  <body>
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="{{ asset ('') }}coreui/#">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/accordion.html"><span class="nav-icon"></span> Accordion</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/breadcrumb.html"><span class="nav-icon"></span> Breadcrumb</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/cards.html"><span class="nav-icon"></span> Cards</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/carousel.html"><span class="nav-icon"></span> Carousel</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/collapse.html"><span class="nav-icon"></span> Collapse</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/list-group.html"><span class="nav-icon"></span> List group</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/navs-tabs.html"><span class="nav-icon"></span> Navs &amp; Tabs</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/pagination.html"><span class="nav-icon"></span> Pagination</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/placeholders.html"><span class="nav-icon"></span> Placeholders</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/popovers.html"><span class="nav-icon"></span> Popovers</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/progress.html"><span class="nav-icon"></span> Progress</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/scrollspy.html"><span class="nav-icon"></span> Scrollspy</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/spinners.html"><span class="nav-icon"></span> Spinners</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/tables.html"><span class="nav-icon"></span> Tables</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/base/tooltips.html"><span class="nav-icon"></span> Tooltips</a></li>
          </ul>
        </li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="{{ asset ('') }}coreui/#">
            <svg class="nav-icon">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/buttons/buttons.html"><span class="nav-icon"></span> Buttons</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/buttons/button-group.html"><span class="nav-icon"></span> Buttons Group</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/buttons/dropdowns.html"><span class="nav-icon"></span> Dropdowns</a></li>
          </ul>
        </li>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="{{ asset ('') }}coreui/#">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/forms/form-control.html"> Form Control</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/forms/select.html"> Select</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/forms/checks-radios.html"> Checks and radios</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/forms/range.html"> Range</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/forms/input-group.html"> Input group</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/forms/floating-labels.html"> Floating labels</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/forms/layout.html"> Layout</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/forms/validation.html"> Validation</a></li>
          </ul>
        </li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="{{ asset ('') }}coreui/#">
            <svg class="nav-icon">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/icons/coreui-icons-free.html"> CoreUI Icons<span class="badge badge-sm bg-success ms-auto">Free</span></a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/icons/coreui-icons-brand.html"> CoreUI Icons - Brand</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/icons/coreui-icons-flag.html"> CoreUI Icons - Flag</a></li>
          </ul>
        </li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="{{ asset ('') }}coreui/#">
            <svg class="nav-icon">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/notifications/alerts.html"><span class="nav-icon"></span> Alerts</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/notifications/badge.html"><span class="nav-icon"></span> Badge</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/notifications/modals.html"><span class="nav-icon"></span> Modals</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/notifications/toasts.html"><span class="nav-icon"></span> Toasts</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item"><a class="nav-link nav-link-danger" href="{{ asset ('') }}coreui/https://coreui.io/pro/" target="_top">
            <svg class="nav-icon">
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
      <header class="header header-sticky mb-4">
        <div class="container-fluid">
          ...
          <ul class="header-nav d-none d-md-flex">
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/#">Dashboard</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/#">Users</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/#">Settings</a></li>
          </ul>
          <ul class="header-nav ms-auto">
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/#">
                <svg class="icon icon-lg">
                  <use xlink:href="{{ asset ('') }}coreui/vendors/@coreui/icons/svg/free.svg#cil-bell"></use>
                </svg></a></li>
            <li class="nav-item"><a class="nav-link" href="{{ asset ('') }}coreui/#">
          ...
          <ul class="header-nav ms-3">
            <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="{{ asset ('') }}coreui/#" role="button" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-md"><img class="avatar-img" src="assets/img/avatars/8.jpg" alt="user@email.com"></div>
              </a>
              <div class="dropdown-menu dropdown-menu-end pt-0">
                <div class="dropdown-header bg-light py-2">
                  <div class="fw-semibold">Account</div>
                </div><a class="dropdown-item" href="{{ asset ('') }}coreui/#">
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset ('') }}coreui/vendors/@coreui/icons/svg/free.svg#cil-bell"></use>
                  </svg> Updates<span class="badge badge-sm bg-info ms-2">42</span></a><a class="dropdown-item" href="{{ asset ('') }}coreui/#">
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset ('') }}coreui/vendors/@coreui/icons/svg/free.svg#cil-envelope-open"></use>
                  </svg> Messages<span class="badge badge-sm bg-success ms-2">42</span></a><a class="dropdown-item" href="{{ asset ('') }}coreui/#">
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset ('') }}coreui/vendors/@coreui/icons/svg/free.svg#cil-task"></use>
                  </svg> Tasks<span class="badge badge-sm bg-danger ms-2">42</span></a><a class="dropdown-item" href="{{ asset ('') }}coreui/#">
                  <svg class="icon me-2">
                ...
                <div class="dropdown-header bg-light py-2">
                  ...
                  </svg> Profile</a><a class="dropdown-item" href="{{ asset ('') }}coreui/#">
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset ('') }}coreui/vendors/@coreui/icons/svg/free.svg#cil-settings"></use>
                  </svg> Settings</a><a class="dropdown-item" href="{{ asset ('') }}coreui/#">
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset ('') }}coreui/vendors/@coreui/icons/svg/free.svg#cil-credit-card"></use>
                  </svg> Payments<span class="badge badge-sm bg-secondary ms-2">42</span></a><a class="dropdown-item" href="{{ asset ('') }}coreui/#">
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset ('') }}coreui/vendors/@coreui/icons/svg/free.svg#cil-file"></use>
                  </svg> Projects<span class="badge badge-sm bg-primary ms-2">42</span></a>
                <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ asset ('') }}coreui/#">
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset ('') }}coreui/vendors/@coreui/icons/svg/free.svg#cil-lock-locked"></use>
                  </svg> Lock Account</a><a class="dropdown-item" href="{{ asset ('') }}coreui/#">
                  <svg class="icon me-2">
                    <use xlink:href="{{ asset ('') }}coreui/vendors/@coreui/icons/svg/free.svg#cil-account-logout"></use>
                  </svg> Logout</a>
              </div>
              ...
              <div class="card mb-4 text-white bg-primary">
                <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="{{ asset ('') }}coreui/#">Action</a><a class="dropdown-item" href="{{ asset ('') }}coreui/#">Another action</a><a class="dropdown-item" href="{{ asset ('') }}coreui/#">Something else here</a></div>
                  </div>
                </div>
                        ...
                        <tr class="align-middle">
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="{{ asset ('') }}coreui/#">Info</a><a class="dropdown-item" href="{{ asset ('') }}coreui/#">Edit</a><a class="dropdown-item text-danger" href="{{ asset ('') }}coreui/#">Delete</a></div>
                            </div>
                          </td>
                        </tr>
                        <tr class="align-middle">
      ...
      <footer class="footer">
        <div><a href="{{ asset ('') }}coreui/https://coreui.io">CoreUI </a><a href="{{ asset ('') }}coreui/https://coreui.io">Bootstrap Admin Template</a> © 2022 creativeLabs.</div>
        <div class="ms-auto">Powered by&nbsp;<a href="{{ asset ('') }}coreui/https://coreui.io/docs/">CoreUI UI Components</a></div>
      </footer>
    </div>
